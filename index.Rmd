...
```{r calendar, echo=FALSE, fig.cap="Example of a DHS calendar filled for one year from DHS website. Birth, pregnancy and contraceptive use are coded in column 1 and related events in column 2 for each months.", out.width = '85%', fig.align = "center"}
